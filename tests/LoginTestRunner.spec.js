...
test('Login Test - Successful login with standard user', async ({ page }) => {
    ...
    await expect(page.url()).toBe('https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index'); // Expect the URL to be 'https://www.saucedemo.com/inventory.html'
